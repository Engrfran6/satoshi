...
options = {
  chart: {height: 360, type: 'area', stacked: !0, toolbar: {show: !1, autoSelected: 'zoom'}},
...
(chart = new ApexCharts(document.querySelector('#apex_area1'), options)).render(),
  $(document).ready(function () {
    ...
    document.querySelector('#one_month').addEventListener('click', function (e) {
      a(e),
        t.updateOptions({
          xaxis: {min: new Date('28 Jan 2013').getTime(), max: new Date('27 Feb 2013').getTime()},
        });
    }),
      document.querySelector('#six_months').addEventListener('click', function (e) {
        a(e),
          t.updateOptions({
            xaxis: {min: new Date('27 Sep 2012').getTime(), max: new Date('27 Feb 2013').getTime()},
          });
      }),
      document.querySelector('#one_year').addEventListener('click', function (e) {
        a(e),
          t.updateOptions({
            xaxis: {min: new Date('27 Feb 2012').getTime(), max: new Date('27 Feb 2013').getTime()},
          });
      }),
      document.querySelector('#ytd').addEventListener('click', function (e) {
        a(e),
          t.updateOptions({
            xaxis: {min: new Date('01 Jan 2013').getTime(), max: new Date('27 Feb 2013').getTime()},
          });
      }),
...
options = {
  ...
  grid: {row: {colors: ['#afb7d21a', 'transparent'], opacity: 0.2}, borderColor: '#f1f3fa'},
};
...
(chart = new ApexCharts(document.querySelector('#apex_bubble'), options2)).render();
options = {
...
(chart = new ApexCharts(document.querySelector('#apex_pie3'), options)).render();
options = {
...
(chart = new ApexCharts(document.querySelector('#apex_radialbar1'), options)).render();
options = {
...
(chart = new ApexCharts(document.querySelector('#apex_radialbar2'), options)).render();
var chart;
options = {
...
(chart = new ApexCharts(document.querySelector('#apex_radialbar3'), options)).render(),
...
var randomizeArray = function (e) {
  ...
  spark1 = {
    ...
    subtitle: {text: 'Sales', offsetX: 20, style: {fontSize: '14px', color: '#8997bd'}},
  };
...
var spark2 = {
  ...
  subtitle: {text: 'Expenses', offsetX: 20, style: {fontSize: '14px', color: '#8997bd'}},
};
...
var spark3 = {
  ...
  subtitle: {text: 'Profits', offsetX: 20, style: {fontSize: '14px', color: '#8997bd'}},
};
