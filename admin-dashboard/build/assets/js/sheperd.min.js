...
(function (G, ca) {
  'object' === typeof exports && 'undefined' !== typeof module
    ...
    ? define(ca)
    : ((G = 'undefined' !== typeof globalThis ? globalThis : G || self), (G.Shepherd = ca()));
})(this, function () {
  function G(a, b) {
  ...
  function fa(a) {
    for (
      var b = z(a), c = Na(a);
      c && 0 <= ['table', 'td', 'th'].indexOf(B(c)) && 'static' === H(c).position;
  ...
  function Qa(a) {
    ...
    if (m) {
      var C = fa(c),
        ...
        D = 'clientWidth';
      C === z(c) &&
        ((C = L(c)), 'static' !== H(C).position && ((u = 'scrollHeight'), (D = 'scrollWidth')));
  ...
  function Fb(a, b, c) {
    ...
    if (e || (!e && !c)) {
      if ('body' !== B(b) || xa(d))
        f = b !== z(b) && y(b) ? {scrollLeft: b.scrollLeft, scrollTop: b.scrollTop} : va(b);
  ...
  function J(a, b, c, d, e, f, h = [-1]) {
    ...
    m.ctx = c
      ? c(a, b.props || {}, (b, c, ...d) => {
          ...
          if (m.ctx && e(m.ctx[b], (m.ctx[b] = d))) {
            ...
            g &&
              (-1 === a.$$.dirty[0] &&
                (ka.push(a), Fa || ((Fa = !0), Pb.then(eb)), a.$$.dirty.fill(0)),
    ...
    b.target &&
      (b.hydrate
        ? ((c = Array.from(b.target.childNodes)), m.fragment && m.fragment.l(c), c.forEach(w))
  ...
  var vb = function (a) {
      ...
      if ((b = !!a && 'object' === typeof a))
        (b = Object.prototype.toString.call(a)),
          (b = !('[object RegExp]' === b || '[object Date]' === b || a.$$typeof === qc));
      return b;
    },
      ...
      return function (a, b, h) {
        function e() {
          g.orderedModifiers.forEach(function (a) {
            ...
            a = a.effect;
            'function' === typeof a &&
              ((b = a({state: g, name: b, instance: t, options: c})), l.push(b || function () {}));
          });
        }
        function f() {
