  ...
  ($.fn.editableform.buttons =
    ...
    $('#inline-sex').editable({
      ...
      display: function (t, e) {
        ...
        n.length
          ? $(this).text(n[0].text).css('color', {'': '#98a6ad', 1: '#5fbeaa', 2: '#5d9cec'}[t])
          : $(this).empty();
      },
    }),
    $('#inline-status').editable({mode: 'inline', inputclass: 'form-control-sm'}),
    $('#inline-group').editable({showbuttons: !1, mode: 'inline', inputclass: 'form-control-sm'}),
