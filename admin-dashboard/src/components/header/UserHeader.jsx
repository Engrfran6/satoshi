    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent" style={{height: '57px'}}>
      <ul className="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 ">
        <li className="nav-item dropdown">
          <a
            className="py-0 nav-link d-flex align-items-center ps-3"
            href="#"
            id="profile-setting"
            role="button"
            ...
            />
            <img
              src="https://templates.iqonic.design/product/qompac-ui/html/dist/assets/images/avatars/avtar_1.png"
              alt="User-Profile"
              className="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded"
              loading="lazy"
            />
            <img
              src="https://templates.iqonic.design/product/qompac-ui/html/dist/assets/images/avatars/avtar_2.png"
              alt="User-Profile"
              className="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded"
              loading="lazy"
            />
            <img
              src="https://templates.iqonic.design/product/qompac-ui/html/dist/assets/images/avatars/avtar_3.png"
              alt="User-Profile"
              className="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded"
              loading="lazy"
            />
            <img
              src="https://templates.iqonic.design/product/qompac-ui/html/dist/assets/images/avatars/avtar_4.png"
              alt="User-Profile"
              className="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded"
              loading="lazy"
            />
            <img
              src="https://templates.iqonic.design/product/qompac-ui/html/dist/assets/images/avatars/avtar_5.png"
              alt="User-Profile"
