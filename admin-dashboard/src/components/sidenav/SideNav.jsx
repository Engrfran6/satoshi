...
export const SideNav = () => {
  ...
  return (
    <aside className="sidebar sidebar-base sidebar-white sidebar-default navs-rounded-all " id="first-tour" data-toggle="main-sidebar" data-sidebar="responsive">
      ...
      <div className="sidebar-list">
        <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li className={`nav-item ${getActiveLink(["/users"])}`}>
            <Link className={`nav-link ${getActiveLink(["/users"])}`} aria-current="page" to="/users">
                <i className="icon" data-bs-toggle="tooltip" title="Crypto" data-bs-placement="right">
