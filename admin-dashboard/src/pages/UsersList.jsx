...
import {EditUserModal} from '../formModals/userForms/EditUserModal';
...
export const UserList = () => {
  ...
  const fetchData = () => {
    userService.getUsers().then((data) => {
      const {docs} = data;
      const filterOutAdmin = docs.filter((users) => users.role !== 'admin');
      setdata(filterOutAdmin);
      ...
      <tr key={key}>
        ...
        <td>
          <div className="flex align-items-center list-user-action">
            ...
            <a
              onClick={() => deleteUser(userId, user)}
              style={{marginRight: '5px'}}
      ...
      <div>
        <div className="row">
          <div className="col-sm-12">
            ...
            <div id="showMoreResults"> Show more result</div>
          </div>
        </div>
      </div>
      <EditUserModal
