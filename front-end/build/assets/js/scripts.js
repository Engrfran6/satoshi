  ...
  (p.ClassNavMenu = function () {
    ...
    (p.CurrentLink = function () {
      var t = window.location.href,
        n = (n = t.substring(0, -1 == t.indexOf('#') ? t.length : t.indexOf('#'))).substring(
          0,
    ...
    (p.Toast = function (t, e, n) {
      ...
      (n.position = n.position ? 'toast-' + n.position : 'toast-bottom-right'),
        ...
        (i =
          '' !== n.icon
            ? '<span class="toastr-icon"><em class="icon ' + n.icon + '"></em></span>'
            : ''),
    ...
    (p.TGL.ddmenu = function (t, e) {
      var t = t || '.nk-menu-toggle',
        ...
        a = e ? f(n, e) : n;
      u(t).on('click', function (t) {
        p.Win.width < d.lg && p.Toggle.dropMenu(u(this), a), t.preventDefault();
      });
    }),
    ...
    (p.TGL.init = function () {
      p.TGL.content('.toggle'),
        ...
        p.TGL.ddmenu('.' + t + '-toggle', {self: t + '-toggle', child: t + '-sub'});
    }),
