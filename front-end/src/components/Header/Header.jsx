            ...
            <span className="w3-bar-item w3-right">
              <ul>
                <li><a href="index.html#">
                    ...
                    <style dangerouslySetInnerHTML={{__html: "\n.goog-logo-link {\n display: none !important;\n                                        }\n\n                                        .goog-te-gadget {\n                                            color: transparent !important;\n                                        }\n\n                                        .goog-te-gadget .goog-te-combo {\n                                            color: black !important;\n                                        }\n\n                                        .goog-te-gadget-icon {\n                                            display: none !important;\n                                            background: url(\"url for the icon.html\") 0 0 no-repeat !important;\n                                        }\n\n                                        /* HIDE the google translate toolbar */\n                                        .goog-te-banner-frame.skiptranslate {\n                                            display: none !important;\n                                            margin-top: 0px !important;\n                                        }\n                                    " }} />
                  </a></li><a href="index.html#">
                </a></ul><a href="index.html#">
              </a></span><a href="index.html#">
              {/* start top search */}
              <div className="top-search bg-theme">
                <div className="container">
                  <form className="search-form" action="index.html#" method="GET" acceptCharset="utf-8">
              ...
              {/* end top search */}
            </a><div className="container"><a href="index.html#">
              </a><div className="row align-items-center"><a href="index.html#">
                </a><div className="col-12 col-lg-12"><a href="index.html#">
                  </a><div className="menu_area alt-font"><a href="index.html#">
                    </a><nav className="navbar navbar-expand-lg navbar-light no-padding"><a href="index.html#">
                        <link rel="icon" href="https://satoshitradepro.com/img/logos/logo.png" type="image/png" />
                      </a><div className="navbar-header navbar-header-custom"><a href="index.html#">
                          {/* start logo */}
                      ...
                      <ul className="navbar-nav ml-auto" id="nav" style={{display: 'none'}}>
                        ...
                        <li><a href="account/register.html" className="butn small theme" style={{height: '50%', marginTop: '17%'}}>
                      ...
                      <div className="attr-nav sm-no-margin sm-margin-70px-right xs-margin-65px-right">
                        <span className="sm-margin-20px-right xs-margin-5px-right">
                          <a href="account/login.html" className="butn small theme">
