export const Company = () => {
  return (
    ...
    <div className="main-wrapper">
      ...
      <section
        ...
        data-overlay-dark={7}
        style={{background: 'url(img/bg/3.jpg)'}}>
      ...
      <section>
        <div className="container">
          <div className="section-heading title-style6">
            ...
            <h3>
              About <span className="font-weight-500">satoshitradepro</span>
            </h3>
            <p className="width-55 sm-width-75 xs-width-95">
              Learn about our company and all the interesting things they are baout us.
            </p>
          </div>
          <div className="row">
            <div className="col-lg-12 col-md-12 sm-margin-20px-bottom">
              <div className="service-simple">
                ...
                <div className="service-simple-inner">
                  ...
                  <p>
                    satoshitradepro is a digital assets investment company created to simplify,
                    ...
                    still expanding and increasing our list of satisfied investors.
                  </p>
                </div>
              </div>
            </div>
            ...
            <section
              ...
              <div className="container text-center">
                <div className="section-heading title-style5 half white">
                  ...
                  <p>
                    Talk to one of our investment advisors concerning your next investment decision.
                  </p>
                </div>
                <a href="company.html#contact" className="butn theme white-hover">
  ...
  <!-- end location section */}
            ...
            <section>
                ...
                <div className="row margin-50px-bottom sm-margin-30px-bottom">
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div className="contact-box">
                      ...
                      <h4>Visit Us</h4>
                      <span>Example Address will be place here </span>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6">
                    <div className="contact-box">
              ...
              <div className="row margin-50px-bottom sm-margin-30px-bottom"></div>
              <div className="container">
                <div className="row">
                  {/* start contact form */}
                  <div className="col-12">
                    ...
                    <form
                      className="quform"
                      action="https://satoshitradepro.org/quform/getin-touch-one.htm"
                      method="post"
              ...
              <div className="container">
                ...
                <div className="testimonial-style3 owl-carousel owl-theme">
                  <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                    <p>
                      satoshitradepro is a great company. I love the customer support and
                      transparency. Quick payouts.
                    </p>
                  ...
                  <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                    <p>
                      I tried this investment company after my colleague introduced it to me, and I
                      must confess, they're really helping me build wealth.
                    </p>
                  ...
                  <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                    <p>
                      I've been with two other investment programs. Even though those other are
                      quite okay, satoshitradepro is very different than they are. You're reliable.
                    </p>
                  ...
                  <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                    <p>
                      You give the best ROI out there. Been investing since college, so I know a
