export const Pricing = () => {
  return (
     ...
     <div className="main-wrapper">
          ...
          <section className="page-title-section2 bg-img cover-background" data-overlay-dark={7} data-background="img/bg/1.jpg">
          ...
          <section>
            <div className="container">
              <div className="section-heading title-style6">
                <div className="alt-font text-theme-color text-uppercase letter-spacing-1">Plans &amp; Pricing</div>
                <h3>Our <span className="font-weight-500">Investment</span> Plans</h3>
                <p className="width-55 sm-width-75 xs-width-95">The broad category of our investment plans and their
                  pricing just goes a long way to show that we have financial solutions for every kind of
                  investor, from the newbie, to the professional, to those who are looking to go long-term in
              ...
              <div className="row">
                <div className="col-lg-6 col-md-12 sm-margin-20px-bottom">
                  <div className="service-simple">
                    ...
                    <div className="service-simple-inner">
                      <h4 className="font-weight-600"><b>STANDARD PLAN</b></h4>
                      <div className="separator-line-horrizontal-full bg-black opacity1 margin-10px-top margin-20px-bottom sm-margin-15px-bottom">
                      </div>
                      <p>Our Standard Plan is for those who want to try their hands in the financial
                      ...
                      <div className="pricing-body">
                        <ul className="list-style1">
                          <li><i className="fas fa-check" />Starting: $500</li>
                          <li><i className="fas fa-check" />Maximum: $49,999</li>
                          <li><i className="fas fa-check" />ROI: 20% Daily</li>
                          <li><i className="fas fa-check" />Period: 7 Days</li>
                          <li><i className="fas fa-check" />Referral Bonus: 5%</li>
                        </ul>
                      </div>
                      <a href="account/register.html" className="butn theme large"><span><b>Choose This
                            Plan</b></span></a>
                    </div>
                  </div>
                </div>
                <div className="col-lg-6 col-md-12 sm-margin-20px-bottom">
                  <div className="service-simple">
                    ...
                    <div className="service-simple-inner">
                      <h4 className="font-weight-600"><b>PROFESSIONAL PLAN</b></h4>
                      <div className="separator-line-horrizontal-full bg-black opacity1 margin-10px-top margin-20px-bottom sm-margin-15px-bottom">
                      </div>
                      <p>Our Professional Plan is designed to give you 50% ROI daily for a period of 5
                        days without breaking the bank. You also get a 10% referral bonus on this
                        package.</p>
                      <div className="pricing-body">
                        <ul className="list-style1">
                          <li><i className="fas fa-check" />Minimum: $50,000</li>
                          <li><i className="fas fa-check" />Maximum: $2,000,000</li>
                          <li><i className="fas fa-check" />ROI: 50% Daily</li>
                          <li><i className="fas fa-check" />Period: 7 Days</li>
                          <li><i className="fas fa-check" />Referral Bonus: 10%</li>
                        </ul>
                      </div>
                      <a href="account/register.html" className="butn theme large"><span><b>Choose This
                            Plan</b></span></a>
          ...
          <div className="container text-center">
            ...
            <a href="company.html" className="butn theme white-hover"><span>Talk To An Advisor</span></a>
          </div>
          </section>
          ...
          <div className="container">
            ...
            <div className="testimonial-style3 owl-carousel owl-theme">
              <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                <p>satoshitradepro is a great company. I love the customer support and transparency. Quick
                  payouts.</p>
              ...
              <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                <p>Of all the investment programs I've done, satoshitradepro is by far the most reliable. The
                  platform is so simple to use.</p>
              ...
              <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                <p>I tried this investment company after my colleague introduced it to me, and I must confess,
                  they're really helping me build wealth.</p>
              ...
              <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                <p>I've been with two other investment programs. Even though those other are quite okay,
                  satoshitradepro is very different than they are. You're reliable.</p>
              ...
              <div className="testmonial-single center-col width-65 sm-width-90 xs-width-80">
                <p>You give the best ROI out there. Been investing since college, so I know a good deal when I
                  see one.</p>
