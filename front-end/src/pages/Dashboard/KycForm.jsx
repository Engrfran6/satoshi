                  ...
                  <div className="nk-block-head-content text-center">
                    ...
                    <div className="nk-block-des">
                      <p>
                        ...
                        go through indentity verification (KYC/AML) to prevent
                        fraud causes.{" "}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="nk-kycfm">
                      ...
                      <div className="nk-kycfm-content">
                        <div className="nk-kycfm-note">
                          ...
                          />
                          <p>
                            Your can’t edit these details once you submitted the
                            form.
                          </p>
                        </div>
                        <div className="row g-4">
                      ...
                      <div className="nk-kycfm-footer">
                        <div className="form-group">
                          <div className="custom-control custom-control-xs custom-checkbox">
                            ...
                            >
                              I Have Read The{" "}
                              <a to="/dsah/kyc-form#">Terms Of Condition</a>{" "}
                              And <a to="/dsah/kyc-form#">Privacy Policy</a>
                            </label>
                          </div>
                        </div>
                        <div className="form-group">
