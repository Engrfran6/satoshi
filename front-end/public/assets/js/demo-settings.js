...
!(function (e) {
  ...
  return (function e(s) {
    ...
    function o(e, t, o) {
      if ('undefined' != typeof document) {
        'number' == typeof (o = d({path: '/'}, i.defaults, o)).expires &&
    ...
    function t(e, t) {
      if ('undefined' != typeof document) {
        for (
          var o = {}, a = document.cookie ? document.cookie.split('; ') : [], n = 0;
          n < a.length;
          n++
        ) {
          var r = a[n].split('='),
  ...
  (function (i, d) {
    var s = d('body'),
      ...
      c = '.nk-header',
      m = ['demo6', 'invest'],
      r = ['style', 'header', 'header_opt', 'skin', 'mode'],
      n = 'light-mode',
      f = 'dark-mode',
      p = '.nk-opt-item',
      h = '.nk-opt-list',
      v = {
        demo6: {header: 'is-theme', header_opt: 'is-regular', style: 'ui-default'},
        invest: {header: 'is-theme', header_opt: 'nk-header-fixed', style: 'ui-default'},
      };
    (i.Demo = {
      save: function (e, t) {
      ...
      apply: function () {
        ...
        for (var e = 0, t = r; e < t.length; e++) {
          var o,
            a,
            n = t[e];
          ('header' !== n && 'header_opt' !== n && 'style' !== n) ||
            ((o = i.Demo.defs(n)),
            d((a = 'header' !== n && 'header_opt' !== n ? s : c)).removeClass(
              i.Demo.style('all', n)
            ),
            'ui-default' !== o && 'is-default' !== o && d(a).addClass(o)),
      ...
      locked: function (e) {
        !0 === e
          ? (d(p + '[data-key=header]')
            ...
            d(p + '[data-key=skin][data-update=default]').addClass('active'))
          : d(p + '[data-key=header]')
              .add(p + '[data-key=skin]')
      ...
      update: function (e, t, o) {
        ...
        i.Demo.apps();
        ('header' !== e && 'header_opt' !== e) ||
          (d((a = 'header' == e || 'header_opt' == e ? c : '')).removeClass(r), d(a).addClass(n)),
          'mode' === e &&
            (s.removeClass(r).removeAttr('theme'),
            n === f
              ? (s.addClass(n).attr('theme', 'dark'), i.Demo.locked(!0))
              : (s.addClass(n).removeAttr('theme'), i.Demo.locked(!1))),
          'style' === e && (s.removeClass(r), s.addClass(n)),
          'skin' === e &&
            ((a = i.Demo.skins(n)),
            (r = d('#skin-default')
              .attr('href')
            ...
            'theme' === a
              ...
              : 0 < d(l).length
              ? d(l).attr('href', r)
              : u.append('<link id="skin-theme" rel="stylesheet" href="' + r + '">')),
          !0 === o && i.Demo.save(e, t);
      },
      reset: function () {
        var t = i.Demo.apps();
        ...
        for (var e = 0, o = r; e < o.length; e++) {
          var a = o[e];
          d("[data-key='" + a + "']").each(function () {
            var e = d(this).data('update');
            ('header' !== a && 'header_opt' !== a && 'style' !== a) ||
              (e === v[t][a] && d(this).addClass('active')),
              ('mode' !== a && 'skin' !== a) ||
                (e !== n && 'default' !== e) ||
        ...
        i.Demo.apply(),
          0 < d(p).length &&
            d(p).each(function () {
              var e = d(this).data('update'),
                t = d(this).data('key');
              ('header' !== t && 'header_opt' !== t && 'style' !== t) ||
                (e === i.Demo.defs(t) &&
                  (d(this).parent(h).find(p).removeClass('active'), d(this).addClass('active'))),
                ('mode' !== t && 'skin' !== t && 'dir' !== t) ||
