      ...
      4: [
        function (t, e, a) {
          ...
          function h(t) {
            ...
            (a = l < 0.5 ? l * (1 + s) : l + s - l * s), (e = 2 * l - a), (n = [0, 0, 0]);
            for (var u = 0; u < 3; u++)
              (i = r + (1 / 3) * -(u - 1)),
                i < 0 && i++,
                i > 1 && i--,
              ...
              (t.controllers.bar = t.DatasetController.extend({
                    ...
                    e.each(
                      ...
                      function (e, a) {
                        ...
                        o.bar &&
                          ...
                          (i.options.stacked === !1 ||
                            (i.options.stacked === !0 && n.indexOf(o.stack) === -1) ||
                            (void 0 === i.options.stacked &&
                              (void 0 === o.stack || n.indexOf(o.stack) === -1))) &&
                          n.push(o.stack);
                      },
                      t
                    ),
                ...
                updateElement: function (t, a, i) {
                  ...
                  (t._model = {
                    ...
                    backgroundColor: d.backgroundColor
                      ? d.backgroundColor
                      : e.getValueAtIndexOrDefault(c.backgroundColor, a, u.backgroundColor),
                    borderSkipped: d.borderSkipped ? d.borderSkipped : u.borderSkipped,
                    borderColor: d.borderColor
                      ? d.borderColor
                      : e.getValueAtIndexOrDefault(c.borderColor, a, u.borderColor),
                    borderWidth: d.borderWidth
                      ? d.borderWidth
                      : e.getValueAtIndexOrDefault(c.borderWidth, a, u.borderWidth),
                  }),
                    t.pivot();
                },
                calculateBarBase: function (t, e) {
                  ...
                  if (
                    ...
                    for (
                      var s = a.chart, l = s.data.datasets, u = Number(l[t].data[e]), d = 0;
                      d < t;
                      d++
                    ) {
                      var c = l[d],
                  ...
                  for (a = 0; a < t; ++a)
                    (e = this.chart.getDatasetMeta(a)),
                      e.bar &&
                        ...
                        (o.options.stacked === !1 ||
                          (o.options.stacked === !0 && r.indexOf(e.stack) === -1) ||
                          (void 0 === o.options.stacked &&
                            (void 0 === e.stack || r.indexOf(e.stack) === -1))) &&
                        r.push(e.stack);
                  return r.length - 1;
                },
                ...
                draw: function (e) {
                  var a,
                    ...
                    s = n.getDataset();
                  for (
                    t.canvasHelpers.clipArea(n.chart.chart.ctx, n.chart.chartArea),
                      a = 0,
                      i = r.length;
                    a < i;
                    ++a
                ...
                updateElement: function (t, a, i) {
                  ...
                  (t._model = {
                    ...
                    backgroundColor: u.backgroundColor
                      ? u.backgroundColor
                      : e.getValueAtIndexOrDefault(d.backgroundColor, a, c.backgroundColor),
                    borderSkipped: u.borderSkipped ? u.borderSkipped : c.borderSkipped,
                    borderColor: u.borderColor
                      ? u.borderColor
                      : e.getValueAtIndexOrDefault(d.borderColor, a, c.borderColor),
                    borderWidth: u.borderWidth
                      ? u.borderWidth
                      : e.getValueAtIndexOrDefault(d.borderWidth, a, c.borderWidth),
                  }),
                    t.pivot();
                },
                calculateBarBase: function (t, e) {
                  ...
                  e.extend(a, {
                    ...
                    _model: {
                      ...
                      hitRadius: u.hitRadius
                        ? u.hitRadius
                        : e.getValueAtIndexOrDefault(d.hitRadius, i, h.hitRadius),
                    },
                  }),
                    ...
                    var n = this,
                      ...
                      g =
                        i && l.animateRotate
                          ...
                          : t.hidden
                          ? 0
                          : n.calculateCircumference(f.data[a]) * (s.circumference / (2 * Math.PI)),
                    ...
                    this.removeHoverStyle(t),
                      (i && l.animateRotate) ||
                        (0 === a
                          ...
                          : (b.startAngle = n.getMeta().data[a - 1]._model.endAngle),
                ...
                updateElement: function (t, e, i) {
                  ...
                  void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius),
                    ...
                    (t._model = {
                      ...
                      pointStyle:
                        l.pointStyle || a.getValueAtIndexOrDefault(u.pointStyle, e, g.pointStyle),
                      ...
                      hitRadius:
                        l.hitRadius || a.getValueAtIndexOrDefault(u.pointHitRadius, e, g.hitRadius),
                    });
                },
                ...
                updateElement: function (t, a, i) {
                  ...
                  e.extend(t, {
                    ...
                    _model: {
                      ...
                      tension: o.tension
                        ? o.tension
                        : e.getValueOrDefault(r.lineTension, n.chart.options.elements.line.tension),
                      radius: o.radius
                        ? o.radius
                        : e.getValueAtIndexOrDefault(r.pointRadius, a, l.radius),
                      backgroundColor: o.backgroundColor
                        ? o.backgroundColor
                        : e.getValueAtIndexOrDefault(r.pointBackgroundColor, a, l.backgroundColor),
                      borderColor: o.borderColor
                        ? o.borderColor
                        : e.getValueAtIndexOrDefault(r.pointBorderColor, a, l.borderColor),
                      borderWidth: o.borderWidth
                        ? o.borderWidth
                        : e.getValueAtIndexOrDefault(r.pointBorderWidth, a, l.borderWidth),
                      pointStyle: o.pointStyle
                        ? o.pointStyle
                        : e.getValueAtIndexOrDefault(r.pointStyle, a, l.pointStyle),
                      hitRadius: o.hitRadius
                        ? o.hitRadius
                        : e.getValueAtIndexOrDefault(r.hitRadius, a, l.hitRadius),
                    },
                  }),
          ...
          e.exports = function (t) {
            ...
            (o.requestAnimFrame = (function () {
              ...
              (o.getRelativePosition = function (t, e) {
                ...
                return (
                  (a = Math.round((((a - s.left - u) / f) * r.width) / e.currentDevicePixelRatio)),
              ...
              update: function (t, a, i) {
                function n(t) {
                  var e,
                    a = t.isHorizontal();
                  a
                    ? ((e = t.update(t.options.fullWidth ? x : C, w)), (I -= e.height))
                ...
                if (t) {
                  var l = t.options.layout,
                    ...
                    f = 0;
                  isNaN(u)
                    ? ((d = u.left || 0), (c = u.right || 0), (h = u.top || 0), (f = u.bottom || 0))
                    : ((d = u), (c = u), (h = u), (f = u));
                  ...
                  e.each(g.concat(m), s),
                    ...
                    e.each(p, s),
                    e.each(v, s),
                    (t.chartArea = {left: F, top: R, right: F + C, bottom: R + I}),
                    e.each(b, function (e) {
                  ...
                  if (
                    ...
                    if (((s.font = f), m)) {
                      ...
                      i.each(a.legendItems, function (t, a) {
                        ...
                        M + w > p.height && ((k += S + o.padding), y.push(S), (S = 0), (M = 0)),
                          (S = Math.max(S, n)),
                          (M += w),
                ...
                draw: function () {
                  ...
                  if (n.display) {
                    ...
                    var b = e(o, g),
                      ...
                      y = function (e, a, i) {
                        if (!(isNaN(b) || b <= 0)) {
                          ...
                          if (
                            (c.setLineDash && c.setLineDash(h(i.lineDash, s.borderDash)),
                      ...
                      S = a.isHorizontal();
                    d = S
                      ? {x: a.left + (l - u[0]) / 2, y: a.top + o.padding, line: 0}
                    ...
                    i.each(a.legendItems, function (t, e) {
                      ...
                      S
                        ? r + n >= l &&
                          ((s = d.y += M), d.line++, (r = d.x = a.left + (l - u[d.line]) / 2))
                        : s + M > a.bottom &&
                ...
                notify: function (t, e, a) {
                  ...
                  for (i = 0; i < u; ++i)
                    if (
                      ...
                      (s = o[e]),
                      'function' == typeof s &&
                        ((r = [t].concat(a || [])), r.push(n.options), s.apply(o, r) === !1))
                    )
                      return !1;
                  return !0;
                },
                  ...
                  if (
                    ...
                    if (d) {
                      ...
                      var k = t.ticks[0],
                        ...
                        w = e(t.ctx, M, c.font);
                      0 !== t.labelRotation
                        ? ((t.paddingLeft = 'bottom' === o.position ? b * S + 3 : b * m + 3),
                          (t.paddingRight = 'bottom' === o.position ? b * m + 3 : b * w + 3))
                        : ((t.paddingLeft = S / 2 + 3), (t.paddingRight = w / 2 + 3));
                    } else
                ...
                draw: function (e) {
                  ...
                  if (o.display) {
                    ...
                    if (
                      (i.each(n.ticks, function (t, a) {
                        if (void 0 !== t && null !== t) {
                          ...
                          if ((!l || s) && void 0 !== t && null !== t) {
                            var u, h;
                            a === ('undefined' != typeof n.zeroLineIndex ? n.zeroLineIndex : 0)
                              ? ((u = c.zeroLineWidth), (h = c.zeroLineColor))
                              : ((u = i.getValueAtIndexOrDefault(c.lineWidth, a)),
                      ...
                      if (p)
                        (_ = n.left + (n.right - n.left) / 2),
                          (F =
                            'bottom' === o.position ? n.bottom - S.size / 2 : n.top + S.size / 2);
                      else {
                    ...
                    if (c.drawBorder) {
                      ...
                      p
                        ? ((B = z = 'top' === o.position ? n.bottom : n.top), (B += W), (z += W))
                        : ((O = L = 'left' === o.position ? n.right : n.left), (O += W), (L += W)),
                        l.beginPath(),
                        l.moveTo(O, B),
                        l.lineTo(L, z),
                        l.stroke();
            ...
            (t.Title = t.Element.extend({
              ...
              fit: function () {
                var e = this,
                  ...
                  l = e.minSize;
                e.isHorizontal()
                  ? ((l.width = e.maxWidth), (l.height = r ? s + 2 * n.padding : 0))
                  : ((l.width = r ? s + 2 * n.padding : 0), (l.height = e.maxHeight)),
                  (e.width = l.width),
                  (e.height = l.height);
              },
              afterFit: i,
              ...
              t.plugins.register({
                ...
                beforeUpdate: function (i) {
                  ...
                  n
                    ...
                    : (t.layoutService.removeBox(i, i.titleBlock), delete i.titleBlock);
                },
              });
          };
        },
            ...
            function r(t, e) {
              ...
              'center' === r
                ...
                s(a.x)
                  ...
                  : l(a.x) && ((o = 'right'), d(a.x) && ((o = 'center'), (r = c(a.y))));
              var g = t._options;
                  ...
                  for (
                    ...
                    (h = u[c]),
                      ...
                      0 === c
                        ...
                        : ((f = d === -1 ? f : u[d]),
                          g.skip ||
                            ((d !== c - 1 && !o) || d === -1 ? l.moveTo(g.x, g.y) : t(f, h),
                            (d = c)));
                  l.stroke(), l.restore();
                },
              }));
              ...
              i = t.Scale.extend({
                ...
                getPixelForValue: function (t, e, a, i) {
                  ...
                  var d = n.height / o,
                    c = d * (e - n.minIndex);
                  return (
                    n.options.gridLines.offsetGridLines && i && (c += d / 2), n.top + Math.round(c)
                  );
                },
                getPixelForTick: function (t, e) {
              ...
              i = t.LinearScaleBase.extend({
                ...
                getPixelForValue: function (t) {
                  ...
                  return a.isHorizontal()
                    ...
                    : ((e = a.bottom - (a.height / o) * (n - i)), Math.round(e));
                },
                getValueForPixel: function (t) {
                  var e = this,
                    a = e.isHorizontal(),
            ...
            var e = t.helpers,
              ...
              i = t.Scale.extend({
                  ...
                  return (
                    o.isHorizontal()
                      ? ((n = e.log10(o.end) - e.log10(r)),
                        0 === s
                          ? (i = o.left)
                          : ((a = o.width), (i = o.left + (a / n) * (e.log10(s) - e.log10(r)))))
                      : ((a = o.height),
                        0 !== r || u.reverse
                          ? 0 === o.end && u.reverse
                            ? ((n = e.log10(o.start) - e.log10(o.minNotZero)),
                              (i =
                                s === o.end
                                  ...
                                  : o.top +
                                    0.02 * a +
                                    ((0.98 * a) / n) * (e.log10(s) - e.log10(o.minNotZero))))
                            : ((n = e.log10(o.end) - e.log10(r)),
                              (a = o.height),
                              (i = o.bottom - (a / n) * (e.log10(s) - e.log10(r))))
                ...
                getValueForPixel: function (t) {
                  ...
                  return (
                    n.isHorizontal()
                      ? ((i = n.width), (a = n.start * Math.pow(10, ((t - n.left) * o) / i)))
                      : ((i = n.height), (a = Math.pow(10, ((n.bottom - t) * o) / i) / n.start)),
                    a
                  );
                },
              });
      ...
      47: [
        function (t, e, a) {
          ...
          e.exports = function (t) {
            ...
            function i(t, e, a) {
              return f.isArray(a)
                ? {w: f.longestText(t, t.font, a), h: a.length * e + 1.5 * (a.length - 1) * e}
              ...
              m = t.LinearScaleBase.extend({
                ...
                getBasePosition: function () {
                  ...
                  return t.getPointPositionForValue(
                    0,
                    t.beginAtZero ? 0 : e < 0 && a < 0 ? a : e > 0 && a > 0 ? e : 0
                  );
                },
                draw: function () {
                  var t = this,
              ...
              var e = t.helpers,
                ...
                o = t.Scale.extend({
                    ...
                    t.chart.data.labels && t.chart.data.labels.length > 0
                      ? (e.each(
                          ...
                          function (e) {
                            var i = t.parseTime(e);
                            i.isValid() &&
                              (t.options.time.round && i.startOf(t.options.time.round), a.push(i));
                          },
                          t
                        ),
                            ...
                            ? e.each(
                                ...
                                function (e) {
                                  ...
                                  a.isValid() &&
                                    ...
                                    s &&
                                      ((t.firstTick =
                                        null !== t.firstTick ? i.min(t.firstTick, a) : a),
                                      (t.lastTick =
                                        null !== t.lastTick ? i.max(t.lastTick, a) : a)));
                                },
                                t
                              )
                            : (r = a),
                  ...
                  getLabelForIndex: function (t, e) {
                    ...
                    return (
                      null !== n && 'object' == typeof n && (i = a.getRightValue(n)),
