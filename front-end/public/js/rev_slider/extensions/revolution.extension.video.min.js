    ...
    resetVideo: function (e, t, a, i) {
      ...
      switch (o.videotype) {
        case 'youtube':
          ...
          try {
            if ('on' == o.forcerewind) {
              ...
              null != o.player &&
                ((l = -1 == l ? 0 : l), o.player.seekTo(l), o.player.pauseVideo());
            }
          } catch (e) {}
        ...
        case 'html5':
          ...
          ('mute' == o.volume || I.lastToggleState(e.videomutetoggledby) || !0 === t.globalmute) &&
            (p.muted = !0);
      }
    },
      ...
      switch (e.videotype) {
        ...
        case 'vimeo':
          if (0 == a.find('iframe').length)
            a.removeData('vimeoplayer'), a.append(a.data('videomarkup')), O(a, i, !0);
        ...
        case 'html5':
          ...
          'video' === f &&
            ...
            ('on' === a.autoplay || 'true' === a.autoplay || !0 === a.autoplay
              ...
              : (1 != a.videoinline && 'true' !== a.videoinline && 1 !== a.videoinline) ||
                (b += ' playsinline'));
          var w =
            '<' +
            f +
      ...
      if (
        ...
        switch (l.videotype) {
          ...
          case 'vimeo':
            ...
            u = (u =
              null != p.player_id ? u.replace(p.player_id, a) : u + '&player_id=' + a).replace(
              /&api=0|&api=1/g,
              ''
            );
            var m = I.is_mobile(),
