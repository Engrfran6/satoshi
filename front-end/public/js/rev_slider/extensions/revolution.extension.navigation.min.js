...
!(function (a) {
      ...
      h(a, f),
        ...
        f.li.each(function (b) {
          ...
          v && (f.navigation.bullets.rtl ? u(a, n, c, f) : u(a, n, d, f)),
            x &&
              (f.navigation.thumbnails.rtl ? w(a, r, c, 'tp-thumb', f) : w(a, r, d, 'tp-thumb', f)),
        ...
        a.bind('revolution.slide.onafterswap revolution.nextslide.waiting', function () {
          ...
          a.find('.tp-bullet').each(function () {
            ...
            g.find('.tp-thumb, .tp-tab').each(function () {
              ...
              a.data('liref') === b
                ? (a.addClass('selected'),
                  a.hasClass('tp-tab') ? e(g.find('.tp-tabs'), s) : e(g.find('.tp-thumbs'), r))
  ...
  var e = function (a, b) {
      var d =
          (a.hasClass('tp-thumbs'), a.hasClass('tp-thumbs') ? '.tp-thumb-mask' : '.tp-tab-mask'),
      ...
      m > 2 &&
        ...
        (q =
          o - j + r + k < j && o + (Math.round(m) - 2) * j < r ? o + (Math.round(m) - 2) * j : q)),
        ...
        a.hasClass('dragged') ||
          ('vertical' === i
            ? h.data(
                'tmmove',
                punchgs.TweenLite.to(h, 0.5, {top: q + 'px', ease: punchgs.Power3.easeInOut})
              )
            : h.data(
                'tmmove',
                punchgs.TweenLite.to(h, 0.5, {left: q + 'px', ease: punchgs.Power3.easeInOut})
              ),
          h.data('offset', q));
    },
                  ...
                  (G = F + i),
                    (G =
                      G > 0
                        ...
                        : G);
                  var H =
                    'vertical' === B ? 0 - (A.height() - z.height()) : 0 - (A.width() - z.width());
                  (G =
                    G < H
                      ? 'horizontal' === B
    ...
    l = function (a) {
      (a.hide_delay = jQuery.isNumeric(parseInt(a.hide_delay, 0)) ? a.hide_delay / 1e3 : 0.2),
        (a.hide_delay_mobile = jQuery.isNumeric(parseInt(a.hide_delay_mobile, 0))
    ...
    o = function (a, b) {
      ...
      n(b.navigation.arrows) &&
        punchgs.TweenLite.delayedCall(
          c ? b.navigation.arrows.hide_delay_mobile : b.navigation.arrows.hide_delay,
          p,
        ...
        n(b.navigation.tabs) &&
          punchgs.TweenLite.delayedCall(
            c ? b.navigation.tabs.hide_delay_mobile : b.navigation.tabs.hide_delay,
            p,
        ...
        h > e && 'outer-left' !== b.position && 'outer-right' !== b.position
          ...
          !0 === b.span && 'vertical' === b.direction
            ...
            : !0 === b.span &&
              ...
              (punchgs.TweenLite.set(a, {maxWidth: '100%', width: e - 2 * g + 'px', left: 0, x: 0}),
              s(j, b, c));
      }
    },
    u = function (a, b, c, d) {
