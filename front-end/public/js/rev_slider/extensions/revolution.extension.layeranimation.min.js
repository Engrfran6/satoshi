...
!(function (e) {
  ...
  jQuery.extend(!0, A, {
    ...
    prepareSingleCaption: function (e) {
      ...
      if (
        ('off' ===
          (void 0 === i.visibility
            ? 'oon'
            : N(i.visibility, a)[a.forcedWinRange] || N(i.visibility, a) || 'ooon') ||
      ...
      if (
        ...
        if (
          ((i.layertype = 'video'), A.manageVideoLayer && A.manageVideoLayer(t, a, n, r), !n && !r)
        ) {
          i.videotype;
        ...
        ((0 == b && !y) || (1 != i.forcecover && !t.hasClass('fullscreenvideo') && !y)) &&
          ...
          a.hover(
            function (e) {
              ...
              (a.forcehover = n.force),
                ...
                (a.hoverzIndex || (a.hoveranim.anim && a.hoveranim.anim.zIndex)) &&
                  ...
                  (a.hoverzIndex =
                    void 0 === a.hoverzIndex ? a.hoveranim.anim.zIndex : a.hoverzIndex),
            ...
            function (e) {
              ...
              (a.hoveredstatus = !1),
                ...
                o.svg &&
                  punchgs.TweenLite.to([o.svg, o.svg.find('path')], n.speed / 1e3, a.idlesvg.anim);
            }
          );
        }
    ...
    createFrameOnTimeline: function (e) {
      ...
      if (
        ...
        void 0 !== b &&
          ((b.anim.ease =
            void 0 === i.frames[r].ease ? punchgs.Power1.easeInOut : i.frames[r].ease),
          (b.speed = void 0 === i.frames[r].speed ? b.speed : i.frames[r].speed),
          (b.anim.x =
            b.anim.x * o.bw || Y(b.anim.x, o, i.eow, i.eoh, i.calcy, i.calcx, 'horizontal')),
          (b.anim.y =
            b.anim.y * o.bw || Y(b.anim.y, o, i.eow, i.eoh, i.calcy, i.calcx, 'vertical'))),
        void 0 !== _ &&
          ((_.anim.ease =
            void 0 === i.frames[r].ease ? punchgs.Power1.easeInOut : i.frames[r].ease),
          (_.speed = void 0 === i.frames[r].speed ? _.speed : i.frames[r].speed),
          (_.anim.x =
            _.anim.x * o.bw || Y(_.anim.x, o, i.eow, i.eoh, i.calcy, i.calcx, 'horizontal')),
          (_.anim.y =
            _.anim.y * o.bw || Y(_.anim.y, o, i.eow, i.eoh, i.calcy, i.calcx, 'vertical'))),
        t.data('iframes') &&
          n.add(punchgs.TweenLite.set(t.find('iframe'), {autoAlpha: 1}), a + '+=0.001'),
        r === i.outframeindex &&
      ...
      if (0 !== r || e.fromcurrentstate)
        if ('block' === i._sfx_out && r === i.outframeindex)
          n.add(d.content.staggerTo(s, 0.001, {autoAlpha: 0, delay: x}), a),
            n.add(
              d.content.staggerTo(s, _.speed / 1e3 / 2 - 0.001, {x: 0, delay: x}),
              a + '+=0.001'
            );
        else if (u && void 0 !== L) {
          R = {to: P(_.anim)};
        ...
        for (var I in s) {
          ...
          (z.ease = C.ease),
            void 0 !== i.frames[r].color &&
              ((C.color = i.frames[r].color), (z.color = i.cssobj.styleProps.color)),
      ...
      return (
        void 0 === v ||
          ...
          ((v.anim.ease =
            void 0 === v.anim.ease || 'inherit' === v.anim.ease ? i.frames[0].ease : v.anim.ease),
          (v.anim.overflow = 'hidden'),
          (v.anim.x =
            v.anim.x * o.bw || Y(v.anim.x, o, i.eow, i.eoh, i.calcy, i.calcx, 'horizontal')),
          (v.anim.y =
            v.anim.y * o.bw || Y(v.anim.y, o, i.eow, i.eoh, i.calcy, i.calcx, 'vertical'))),
        (0 === r && h && !1 !== h && !e.fromcurrentstate) || (0 === r && e.ignorefirstframe)
          ? (((v = new Object()).anim = new Object()),
            ...
            h &&
              !1 !== h &&
              ((h.anim.x =
                h.anim.x * o.bw || Y(h.anim.x, o, i.eow, i.eoh, i.calcy, i.calcx, 'horizontal')),
              (h.anim.y =
                h.anim.y * o.bw || Y(h.anim.y, o, i.eow, i.eoh, i.calcy, i.calcx, 'vertical')),
  ...
  var O = function (e, t, i, a, n, r, o, s, d) {
      ...
      if (
        ((l.layer = o),
        (l.eventtype =
          0 === e ? 'enterstage' : e === a.outframeindex ? 'leavestage' : 'framestarted'),
    ...
    S = function (e, t, i, a, n, r, o, s, d) {
      ...
      (l.layer = s),
        (l.eventtype =
          0 === e ? 'enteredstage' : e === t - 1 || e === i ? 'leftstage' : 'frameended'),
    ...
    g = function (e) {
      ...
      return (
        ...
        (t.slideid =
          e.caption.data('slideid') || e.caption.closest('.tp-revslider-slidesli').data('index')),
    ...
    B = function (e) {
      return (
        ...
        (e.anim.transformOrigin =
          void 0 === e.anim.transformOrigin ? '50% 50%' : e.anim.transformOrigin),
        (e.anim.transformPerspective =
          void 0 === e.anim.transformPerspective ? 600 : e.anim.transformPerspective),
  ...
  var v = function (a, e) {
      ...
      var t = (e = (e = (e = (e = (e = (e = (e = (e = e.replace('c:', 'color:')).replace(
        'bg:',
        'background-color:'
      )).replace('bw:', 'border-width:')).replace('bc:', 'border-color:')).replace(
        'br:',
        'borderRadius:'
      )).replace('bs:', 'border-style:')).replace('td:', 'text-decoration:')).replace(
        'zi:',
        'zIndex:'
      )).split(';');
      return (
      ...
      if (
        ...
        if (
          ...
          (a.fontWeight = n
            ...
            : e.data('fontweight')),
          (a.minWidth =
            void 0 === e.data('width') ? parseInt(e.css('minWidth'), 0) || 0 : e.data('width')),
          (a.minHeight =
            void 0 === e.data('height') ? parseInt(e.css('minHeight'), 0) || 0 : e.data('height')),
        ...
        (a.maxWidth =
          void 0 === e.data('width') ? parseInt(e.css('maxWidth'), 0) || 'none' : e.data('width')),
          (a.maxHeight =
          ...
          (a.man =
            void 0 === e.data('man')
              ...
              : e.data('man')),
          (a.ani =
            void 0 === e.data('ani') ? parseInt(e.css('transition'), 0) || 'none' : e.data('ani'));
      }
      return (
        (a.styleProps = {
