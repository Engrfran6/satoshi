...
!(function (a) {
  ...
  jQuery.extend(!0, b, {
    ...
    organiseCarousel: function (a, b, c, d) {
      b =
        void 0 === b || 'down' == b || 'up' == b || null === b || jQuery.isEmptyObject(b)
          ? 'left'
          : b;
      for (
        var e = a.carousel,
      ...
      e.slides &&
        jQuery.each(e.slides, function (d, h) {
          ...
          'on' === e.infinity &&
            ((i =
              i > e.wrapwidth - e.inneroffset && 'left' === b ? f[0] - (g - d) * e.slide_width : i),
            (i =
          ...
          if (void 0 !== e.minScale && e.minScale > 0)
            if ('on' === e.vary_scale) {
              ...
              j.scale =
                l >= 1 || l <= -1 ? 1 - e.minScale / 100 : (100 - e.minScale * Math.abs(l)) / 100;
          ...
          void 0 !== e.maxRotation &&
            ...
            ('on' === e.vary_rotation
              ? ((j.rotationY =
                  ...
                  Math.abs(
                    (1 - Math.abs((1 / Math.ceil(e.maxVisibleItems / n)) * l)) * e.maxRotation
                  )),
            ...
            (j.transformStyle =
              '3D' != a.parallax.type && '3d' != a.parallax.type ? 'flat' : 'preserve-3d'),
  ...
  var d = function (a) {
    ...
    e = function (a) {
      ...
      void 0 === c.wrap && d(a),
        ...
        (c.wrapoffset =
          'center' === c.horizontal_align ? (a.c.width() - f - e - c.wrapwidth) / 2 : 0),
        (c.wrapoffset =
          'auto' != a.sliderLayout && a.outernav ? 0 : c.wrapoffset < e ? e : c.wrapoffset);
      var g = 'hidden';
    ...
    j = function (a) {
      ...
      if ((void 0 !== d.positionanim && d.positionanim.kill(), 'none' == d.slide_globaloffset))
        d.slide_globaloffset = c =
          'center' === d.horizontal_align ? d.wrapwidth / 2 - d.slide_width / 2 : 0;
      else {
