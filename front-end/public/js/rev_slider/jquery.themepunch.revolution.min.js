  ...
  jQuery.fn.extend({
      ...
      return (
        ...
        this.each(function () {
          ...
          (i.minHeight = i.minHeight != undefined ? parseInt(i.minHeight, 0) : i.minHeight),
            ...
            (i.jsFileLocation =
              i.jsFileLocation || getScriptLocation('themepunch.revolution.min.js')),
    ...
    revkill: function (e) {
      ...
      if (
        ...
        return (
          t.empty(), t.html(), (n = t = null), delete i.c, delete i.opt, delete i.container, !0
        );
      }
      return !1;
    },
        ...
        'stop' != e.check &&
          (_R.getversion().core < e.min_core
            ? (e.check === undefined &&
                ...
                console.log(
                  '%c     Core is older than expected (' + e.min_core + ') from ' + e.alias,
                  'color:#333'
                ),
                console.log(
  ...
  var _ISM = _R.is_mobile(),
    ...
    lAjax = function (i, t) {
      return (
        ...
        (t.filesystem
          ? (t.errorm === undefined &&
              (t.errorm = '<br>Local Filesystem Detected !<br>Put this to your header:'),
          ...
          : (jQuery.ajax({
              ...
              error: function (e) {
                console.warn('Slider Revolution 5.0 Error !'),
                  console.error(
                    'Failure at Loading:' + i + t.extensions_suffix + ' on Path:' + t.jsFileLocation
                  ),
                  console.info(e);
              },
            }),
            ...
            e.find('.tp-caption, .tp-static-layer, .rs-background-video-layer').each(function () {
              ...
              (e.data('ytid') != undefined ||
                (0 < e.find('iframe').length &&
                  0 < e.find('iframe').attr('src').toLowerCase().indexOf('youtube'))) &&
                (i.videos = !0),
    ...
    initSlider = function (container, opt) {
      ...
      container.data('aimg') != undefined &&
        ...
        container.html(
          '<img class="tp-slider-alternative-image" src="' + container.data('aimg') + '">'
        ),
        ...
        (j.addedyt = 0),
          ...
          t.find('.tp-caption, .rs-background-video-layer').each(function (e) {
            var n = jQuery(this),
              ...
              a = i.autoplay,
              r =
                (i.videomp4 !== undefined || i.videowebm !== undefined || i.videoogv,
            ...
            if (
              ...
              jQuery.each(['pendulum', 'rotate', 'slideloop', 'pulse', 'wave'], function (e, i) {
                ...
                n.attr('id') === undefined &&
                  n.attr('id', 'layer-' + Math.round(999999999 * Math.random())),
                checkIDS(x, n),
          ...
          x.allli.each(function (e) {
            ...
            punchgs.TweenLite.set(this, {perspective: 6e3}),
              ...
              ('all' != x.lazyType &&
                ('smart' != x.lazyType ||
                  (0 != e && 1 != e && e != x.slideamount && e != x.slideamount - 1))) ||
        ...
        (x.inviewport = !1),
          ...
          setTimeout(function () {
            if (
              ...
              (x.c.addClass('tp-waitforfirststart'), (x.waitForFirstSlide = !0), g.presize)
            ) {
              var e = jQuery(x.li[0]);
              loadImages(e, x, 0, !0),
            ...
            'always' == x.fallbacks.ignoreHeightChanges
              ? ((x.fallbacks.ignoreHeightChangesSize =
                ...
                (e =
                  ...
                  Math.abs(i - x.lastwindowheight) > x.fallbacks.ignoreHeightChangesSize))
        ...
        u.allli.find('>img').each(function (e) {
          ...
          i.closest('.slotholder').data(r),
            ...
            'none' != u.dottedOverlay &&
              ...
              i
                .closest('.slotholder')
                .append('<div class="tp-dottedoverlay ' + u.dottedOverlay + '"></div>');
          var o = i.attr('src');
          (r.src = o),
        ...
        if (
          (t &&
            ...
            (!t.error && jQuery.now() - e.data('start-to-load') < 5e3
              ...
              : ((t.progress = 'failed'),
                t.reported_img ||
                  ((t.reported_img = !0), console.warn(i + '  Could not be loaded !')))),
          ...
          !0 !== i.static ||
            ...
            ('failed' == i.progress
              ? i.reported ||
                ((i.reported = !0),
                console.warn(
                  'Static Image ' + i.src + '  Could not be loaded in time. Error Exists:' + i.error
                ))
    ...
    swapSlide = function (e) {
      ...
      !0 === i.onlyPreparedSlide &&
        ((i.onlyPreparedSlide = !1), jQuery(i.li[0]).addClass('processing-revslide')),
        ...
        a.index() === i.slideamount - 1 &&
          ((i.looptogo = i.looptogo - 1), i.looptogo <= 0 && (i.stopLoop = 'on')),
        (i.tonpause = !0),
        e.trigger('stoptimer'),
        (i.cd = 0),
        'off' === i.spinner &&
        ...
        waitForCurrentImages(a, i, function () {
          a.find('.rs-background-video-layer').each(function () {
            ...
            e.hasClass('HasListener') ||
              (e.data('bgvideo', 1), _R.manageVideoLayer && _R.manageVideoLayer(e, i)),
    ...
    swapSlideProgress = function (e, i) {
      ...
      if (((o.currentSlide = t.index()), (o.nextSlide = a.index()), 'carousel' == o.sliderType))
        ...
        o.ie &&
          ...
          'on' == r.data('kenburns') &&
            (_R.startKenBurn(r, o), c.add(punchgs.TweenLite.set(r, {autoAlpha: 0}))),
          c.pause();
      }
      _R.scrollHandling &&
      ...
      var a = function () {
        0 == jQuery('body').find(e).length && (removeAllListeners(e, i), clearInterval(i.cdint)),
          ...
          1 == e.data('conthover-changed') &&
            ((i.conthover = e.data('conthover')), e.data('conthover-changed', 0)),
          _R.callingNewSlide(e, 1);
      };
      (t[0].tween = punchgs.TweenLite.fromTo(
        t,
    ...
    getUrlVars = function (e) {
      for (
        var i,
          t = [],
          a = window.location.href.slice(window.location.href.indexOf(e) + 1).split('_'),
          n = 0;
        n < a.length;
        n++
      )
